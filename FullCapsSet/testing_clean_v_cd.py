...
MODEL = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/FullCapsSet/fecundity_model_clean_v1.keras"

ONE_DATASET_CD = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/TestingSets/Winter 2017 2 21 C pops cap-sliced"
...
with open("clean_training_vs_CD_testing.csv", "w", newline='') as file:
...
df = pd.read_csv('clean_training_vs_CD_testing.csv')
...
plt.tight_layout()
plt.plot()
plt.savefig("FullCapsSplitCounted_clean_training_vs_CD_testing")