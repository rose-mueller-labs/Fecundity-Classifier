...
def main(p): # changed argv into path
    # path = ""
    # path = argv
...
dp = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/TrainingSets/FullCapsClean"
main(dp) # to run, type: > python3 image_shredder.py [folder-path]