...
MODELS = {
    ...
    'NEURAL_COLLAPSE': (f'{BASE_DIR}/Nueral_collapse.h5', None),
    'NEURAL_COLLAPSE2': (f'{BASE_DIR}/Nueral_collapse_no_zero.h5', None),
    'CLUSTERING_MODEL': (f'{BASE_DIR}/alex_5-1_5-2S_v0.0.h5', None),
    'Extra': (f'{BASE_DIR}/alex_4-30_5-2O_v0.0.h5', None),
    'Extra2': (f'{BASE_DIR}/alex_4-30_5-1_5-2O_v0.0.h5', None)
}
...
def get_tile_preds(name, model, model2, set_name, TESTING_SET, output_dir):
    ...
    csv_name = os.path.join(output_dir, f'{set_name}_{name}_tile_counts_cage_testing.csv')
   ...
   actual_csv_name = os.path.join(output_dir, f'{set_name}_{name}_sums_cage_testing.csv')
