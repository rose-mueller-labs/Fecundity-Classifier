...
MODEL = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/fecundity_model_aug_str_v2.keras"

ONE_DATASET_CD = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/TestingSets/SilkyJohnson2Testing"
...
with open("SJ2Tr_lithium_training_vs_lith_testing.csv", "w", newline='') as file:
...
df = pd.read_csv('SJ2Tr_lithium_training_vs_lith_testing.csv')
...
plt.tight_layout()
plt.plot()
plt.savefig("SJ2Tr_lithium_training_vs_lith_testing")