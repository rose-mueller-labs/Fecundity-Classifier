...
df = pd.read_csv('/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/InferenceCSVFiles/5-1_marvin_alex_comparison_correct.csv')
...
plt.tight_layout()
plt.plot()
plt.savefig("alex_marvin_MSE_and_metrics")