MODEL = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/fecundity_model_zero_or_not.keras"
...
with open("0_or_not_training_vs_CD_zon.csv", "w", newline='') as file:
...
df = pd.read_csv('0_or_not_training_vs_CD_zon.csv')
...
plt.tight_layout()
plt.plot()
plt.savefig("ZERO_OR_NOT_0_or_not_training_vs_CD_zon")