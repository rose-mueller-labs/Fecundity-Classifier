...
EGG_CNT_PATH = "fecundity_model_no_zeros.keras"
...
with open("dual_model_vs_CD_testing.csv", "w", newline='') as file:
...
df = pd.read_csv('dual_model_vs_CD_testing.csv')
...
plt.tight_layout()
plt.plot()
plt.savefig("DUAL_MODEL_vs_CD_testing")