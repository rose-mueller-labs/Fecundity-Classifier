...
ONE_DATASET_CD = "/home/drosophila-lab/Documents/Fecundity/CNN-Classifier/TestingSets/5-1-cap-800x800-sliced-Alexander"
...
with open("lith51.csv", "w", newline='') as file:
